    ...
    return <section>
        <header className='py-6 lg:py-4 w-full h-[60px] transition-all z-10 bg-[#A57CE6]'>
            ...
            <div className='flex justify-center mt-[-40px] text-white w-full'>
                <span className='font-bold text-[30px] mx-[400px]'>Content Approval</span>
        ...
        <div className="flex gap-[40px] ml-[360px] mt-[120px]">
        <div className="">
      ...
      >
        ...
        <div className="mt-[40px]">
            <p className="text-center font-bold">Currently, No content is needed to be approved!</p>
        </div>

    </section>
};

export default ConentApproval;