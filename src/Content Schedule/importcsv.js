...
const Importcsv = () => {
    ...
    const { bell, user, link, file, edit, calendar, graph, hashtag,document } = schedule;
    ...
    return <section>
        <header className='py-6 lg:py-4 w-full h-[60px] transition-all z-10 bg-[#A57CE6]'>
            ...
            <div className='flex justify-center mt-[-40px] text-white w-full'>
                <span className='font-bold text-[30px] mx-[400px]'>Import CSV</span>
      ...
      >
        ...
        <div class="flex flex-row items-center justify-center mt-[80px]">
          <button class="mx-[530px] bg-[#A57CE6] w-[200px] hover:bg-blue-700 text-white font-bold py-2 px-4 btn btn-md md:btn-md rounded-[30px] focus:outline-none focus:shadow-outline" type="button">
            <img src={document} alt="" /> Import CSV
          </button>
        </div>
        <p className='mt-[5px] underline underline-offset-1 flex justify-center'>Advanced</p>
        <div className="flex items-center justify-center mt-[10px]">
        <button className='flex items-center rounded-full bg-[#EFEFEF] w-[130px]  btn btn '>
            Choose file
        </button>
        </div>
